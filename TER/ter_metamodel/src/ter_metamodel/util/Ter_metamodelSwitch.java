 ...
 * @generated
 */
public class Ter_metamodelSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case Ter_metamodelPackage.GROUP_BOX: {
				GroupBox groupBox = (GroupBox)theEObject;
				T result = caseGroupBox(groupBox);
				if (result == null) result = caseElement(groupBox);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ter_metamodelPackage.ELEMENT: {
				Element element = (Element)theEObject;
				T result = caseElement(element);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ter_metamodelPackage.MUTEX: {
				Mutex mutex = (Mutex)theEObject;
				T result = caseMutex(mutex);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ter_metamodelPackage.FEATURE: {
				Feature feature = (Feature)theEObject;
				T result = caseFeature(feature);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ter_metamodelPackage.ECFD: {
				Ecfd ecfd = (Ecfd)theEObject;
				T result = caseEcfd(ecfd);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Ter_metamodelPackage.FILE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Ecfd</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Ecfd</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEcfd(Ecfd object) {
		return null;
	}
